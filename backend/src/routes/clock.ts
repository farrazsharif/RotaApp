...
// Carer self-records a PAST visit they forgot to clock in/out for (own visits,
// within a 7-day window). Audited as recorded-late.
router.post('/records/self', createOwnClockRecord);
