...
import staffSupervisionRoutes from './routes/staffSupervision';
...
import carePlanVersionRoutes from './routes/carePlanVersions';
import likesDislikesVersionRoutes from './routes/likesDislikesVersions';
import riskAssessmentVersionRoutes from './routes/riskAssessmentVersions';
...
app.use('/api/staff-supervision', staffSupervisionRoutes);
...
app.use('/api/care-plan-versions', carePlanVersionRoutes);
app.use('/api/likes-dislikes-versions', likesDislikesVersionRoutes);
app.use('/api/risk-assessment-versions', riskAssessmentVersionRoutes);
