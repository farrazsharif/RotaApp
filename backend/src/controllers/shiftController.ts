...
const shiftInclude = {
  ...
  serviceUser: { select: { id: true, firstName: true, lastName: true, address: true, postcode: true, careType: true, handlesMoney: true, status: true, statusUpdatedAt: true, statusChanges: { select: { status: true, effectiveAt: true }, orderBy: { effectiveAt: 'asc' as const } }, site: { select: { id: true, name: true, color: true, order: true } } } },
