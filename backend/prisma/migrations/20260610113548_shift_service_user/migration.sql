...
INSERT INTO "new_Shift" ("createdAt", "date", "departmentId", "endTime", "id", "notes", "role", "startTime", "status", "updatedAt", "userId") SELECT "createdAt", "date", "departmentId", "endTime", "id", "notes", "role", "startTime", "status", "updatedAt", "userId" FROM "Shift";
DROP TABLE "Shift";
